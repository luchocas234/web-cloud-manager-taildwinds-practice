...
export default function Footer() {
  return (
    <div className='w-full mt-2 bg-slate-900 text-gray-300 py-y px-2'>
        ...
        <div className='flex max-w-[1240] px-2 py-4 mx-auto items-center justify-around sm:flex-row text-center text-gray-500'>
